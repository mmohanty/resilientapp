...
import com.example.circuitbreaker.channel.ExternalAPICaller;
...
public class ResilientAppController {
    ...
    @CircuitBreaker(name = "CircuitBreakerService", fallbackMethod = "fallbackAfterFail")
    ...
    public String fallbackAfterFail(Exception ex) {
        return "all calls have exhausted";
    }
}
